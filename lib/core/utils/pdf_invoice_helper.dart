    ...
    if (overrideItems == null) {
      for (var order in orders) {
        if (order.orderItems != null) {
          final doneItems =
              order.orderItems!.where((item) => item.status == 'done').toList();
      ...
      pw.Page(
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              pw.Text('SEN VÀNG INDOCHINE',
                  style: pw.TextStyle(font: fontBold, fontSize: 16)),
              pw.SizedBox(height: 4),
              pw.Text('HOÁ ĐƠN TẠM TÍNH',
                  style: pw.TextStyle(font: fontBold, fontSize: 14)),
              pw.SizedBox(height: 8),
              pw.Text('Bàn: $tableInfo',
                  style: pw.TextStyle(font: font, fontSize: 12)),
              pw.Text('Ngày: ${dateFormat.format(DateTime.now())}',
                  ...
                  return pw.Padding(
                    ...
                    child: pw.Row(
                      ...
                      children: [
                        ...
                        pw.Expanded(
                          flex: 1,
                          child: pw.Text(_formatPrice(item.total.toInt()),
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text(_formatPrice(grandTotal.toInt()),
                      style: pw.TextStyle(font: fontBold, fontSize: 12)),
                ],
              ),
